...
// Color palette (mutable to support high-contrast toggle)
var (
...
var (
	...
	highContrastPalette = palette{
		...
		purpleBold: "\033[1;97m", // bright white bold for headings
		gray:       "\033[1;97m", // bright white
		red:        "\033[1;91m",
		yellow:     "\033[1;93m",
		green:      "\033[1;92m",
		blue:       "\033[1;94m",
...
func setHighContrast(enabled bool) {
	p := defaultPalette
	if enabled {
		p = highContrastPalette
	}
	colorPurple = p.purple
	colorPurpleBold = p.purpleBold
	colorGray = p.gray
	colorRed = p.red
